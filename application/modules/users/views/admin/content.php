			...
			<div class="portlet-body">
				...
				<form id="membersForm" action="<?php echo base_url('users/addMember');?>" method="post" class="form-horizontal validateForm" enctype="multipart/form-data">
					<div class="form-body">
						...
						<hr>
							<h3 class="section-title">Accounting (Savings)</h3>
						<hr>
						<div class="form-group">
							...
							<div class="col-md-3">
								<input type="number" class="form-control" name="members_account_info*accAmount" value="" placeholder="Amount">
							</div>
							<input type="hidden" class="form-control" name="members_account_info*accExpireDate" value="">
							<div class="col-md-3">
