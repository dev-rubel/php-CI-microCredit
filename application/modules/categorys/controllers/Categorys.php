...
/* 
	Module: Categorys Module Section
	Author: Nihal IT
...
class Categorys extends MX_Controller  
{
	...
	{
        $this->activeMenu('active manu');
        $data = ['title','pagename','']; /* P1=TITLE|P2=PAGENAME|P3=PARAMITER */
		$this->loadAllContent($data);	
    }    
    
    function branchCategory()
    {
        $this->activeMenu('Branch Category');
        $data = ['Branch Category','branch','']; /* P1=TITLE|P2=PAGENAME|P3=PARAMITER */
		$this->loadAllContent($data);
    }
