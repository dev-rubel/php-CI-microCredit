...
<div class="panel panel-success">
	<div class="panel-heading">Register SDF Account</div>
	<div class="panel-body">
	<!-- id="createSdfAccount"  -->
	<form id="createSdfAccount" action="<?php echo base_url('deposit/createSdfAccount/').$memberId;?>" method="post" class="form-horizontal validateForm">
		<div class="form-body">
		...
		<hr>
			<h3 class="section-title">Accounting (SDF)</h3>
		<hr>
		<div class="form-group">
			<div class="col-md-2">
				<select id="sdfTerm" class="form-control">
...
$('#issueDate').on('change',function(){
	if(this.value) {
		var sdfTerm = $('#sdfTerm').val();
		if(sdfTerm) {
			var date = this.value.split("-");
			var date = new Date(date[2],date[1]-1,date[0]);
			date.setFullYear( date.getFullYear() + parseInt(sdfTerm) );
